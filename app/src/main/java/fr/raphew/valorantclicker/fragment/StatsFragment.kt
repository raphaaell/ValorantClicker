...
class StatsFragment(mainActivity: MainActivity) : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val totalClicks: Int = sharedPreferences.getInt("click", 0)
        ...
        val sovaClicks: Int = sharedPreferences.getInt("clickSova", 0)
        ...
        val razeClicks: Int = sharedPreferences.getInt("clickRaze", 0)
        ...
        val sageClicks: Int = sharedPreferences.getInt("clickSage", 0)
        ...
        val reynaClicks: Int = sharedPreferences.getInt("clickReyna", 0)
        ...
        val phoenixClicks: Int = sharedPreferences.getInt("clickPhoenix", 0)
        ...
        val breachClicks: Int = sharedPreferences.getInt("clickBreach", 0)
        ...
        val brimstoneClicks: Int = sharedPreferences.getInt("clickBrimstone", 0)
        ...
        val jettClicks: Int = sharedPreferences.getInt("clickJett", 0)
        ...
        val viperClicks: Int = sharedPreferences.getInt("clickViper", 0)
        ...
        val cypherClicks: Int = sharedPreferences.getInt("clickCypher", 0)
        ...
        val omenClicks: Int = sharedPreferences.getInt("clickOmen", 0)
