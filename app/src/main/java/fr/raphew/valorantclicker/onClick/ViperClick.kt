...
class ViperClick(mainActivity: MainActivity) : View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id){
            R.id.img_viper -> {
                ...
                clickAgents = sharedPreferences.getFloat("clickViper", 0F)
                pp()
                save()
                val a = "$click "
    ...
    private fun save(){
        ...
        editor.putFloat("clickViper", clickAgents)
        editor.apply()
    }
