...
class RazeClick(mainActivity: MainActivity) : View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id){
            R.id.img_raze -> {
                ...
                clickAgents = sharedPreferences.getFloat("clickRaze", 0F)
                pp()
                save()
                val a = "$click "
    ...
    private fun save(){
        ...
        editor.putFloat("clickRaze", clickAgents)
        editor.apply()
    }
